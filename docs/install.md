...
1. Téléchargez le module sur votre serveur [à partir d'une release](https://github.com/PnX-SI/gn_module_suivi_habitat_station/releases) :
    ```bash
    wget https://github.com/PnX-SI/gn_module_suivi_habitat_station/archive/X.Y.Z.zip
    ```
...
1. Rétrograder la base de données pour y enlever les données spécifiques au module :
    ```bash
    geonature db downgrade shs@base
    ```
