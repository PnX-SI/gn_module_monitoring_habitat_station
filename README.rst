...
* Dans le fichier ``settings.ini``, vous avez la possibilité de configurer l'installation du module. Pour permettre l'ajout de la nomenclature CBNA, l'ajout du référentiel Habref et l'insertion d'un jeu de données de test (``data/shs_data.sql``).
