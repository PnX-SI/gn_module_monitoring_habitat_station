...
\echo '--------------------------------------------------------------------------------'
\echo 'Delete habitats in habitats list'
...
DELETE FROM :moduleSchema.cor_hab_taxon
WHERE id_cor_hab_taxon IN (
    SELECT cht.id_cor_hab_taxon
    FROM :moduleSchema.cor_hab_taxon as cht
